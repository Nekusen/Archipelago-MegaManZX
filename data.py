...
LOCATIONS = {
    ...
    'Life Up - Area D01': {'id': 13631744, 'category': 'life_up', 'detect': ['bit', 34929783, 0], 'room': 'd01', 'pos': [3144, 728], 'status': 'verified'},
    'Life Up - Area F02': {'id': 13631745, 'category': 'life_up', 'detect': ['bit', 34929783, 1], 'room': 'f02', 'pos': [712, 544], 'status': 'verified'},
    'Life Up - Area J01': {'id': 13631746, 'category': 'life_up', 'detect': ['bit', 34929783, 2], 'room': 'j01', 'pos': [728, 872], 'status': 'verified'},
    'Life Up - Area I05': {'id': 13631747, 'category': 'life_up', 'detect': ['bit', 34929783, 3], 'room': 'i05', 'pos': [2800, 456], 'status': 'verified'},
    'Sub Tank - Area A02': {'id': 13631760, 'category': 'sub_tank', 'detect': ['bit', 34929784, 0], 'room': 'a02', 'pos': [488, 528], 'status': 'verified'},
    'Sub Tank - Area E04': {'id': 13631761, 'category': 'sub_tank', 'detect': ['bit', 34929784, 1], 'room': 'e04', 'pos': [2644, 840], 'status': 'verified'},
    'Sub Tank - Area K01': {'id': 13631762, 'category': 'sub_tank', 'detect': ['bit', 34929784, 2], 'room': 'k01', 'pos': [7216, 1314], 'status': 'verified'},
    'Mission - Catch The Maverick': {'id': 13632257, 'category': 'mission', 'detect': ['bit', 34620894, 2], 'room': 'A-2', 'pos': None, 'status': 'provisional'},
    'Mission - Locate Giro': {'id': 13632258, 'category': 'mission', 'detect': ['bit', 34620894, 5], 'room': 'B-1B-2', 'pos': None, 'status': 'provisional'},
    'Mission - Pass The Test': {'id': 13632259, 'category': 'mission', 'detect': ['bit', 34620895, 1], 'room': 'C-1C-2', 'pos': None, 'status': 'provisional'},
    'Mission - Troop Reinforcement': {'id': 13632260, 'category': 'mission', 'detect': ['bit', 34620896, 2], 'room': 'D-2', 'pos': None, 'status': 'provisional'},
    'Mission - Search The Plant': {'id': 13632261, 'category': 'mission', 'detect': ['bit', 34620897, 3], 'room': 'E-7', 'pos': None, 'status': 'provisional'},
    'Mission - Find The Survivors': {'id': 13632262, 'category': 'mission', 'detect': ['bit', 34620897, 6], 'room': 'F', 'pos': None, 'status': 'provisional'},
    'Mission - Fight The Mavericks': {'id': 13632263, 'category': 'mission', 'detect': ['bit', 34620898, 1], 'room': 'G', 'pos': None, 'status': 'provisional'},
    'Mission - Secure The Biometal': {'id': 13632264, 'category': 'mission', 'detect': ['bit', 34620900, 1], 'room': 'H-4', 'pos': None, 'status': 'provisional'},
    'Mission - Save The People': {'id': 13632265, 'category': 'mission', 'detect': ['bit', 34620900, 5], 'room': 'I-3', 'pos': None, 'status': 'provisional'},
    'Mission - Recover The Disk': {'id': 13632266, 'category': 'mission', 'detect': ['bit', 34620901, 1], 'room': 'J-5', 'pos': None, 'status': 'provisional'},
    'Mission - Attack The Excavators': {'id': 13632267, 'category': 'mission', 'detect': ['bit', 34620901, 4], 'room': 'K-4', 'pos': None, 'status': 'provisional'},
    'Mission - Protect The Lab': {'id': 13632268, 'category': 'mission', 'detect': ['bit', 34620902, 0], 'room': 'L-4', 'pos': None, 'status': 'provisional'},
    'Mission - Protect Hq': {'id': 13632269, 'category': 'mission', 'detect': ['bit', 34620902, 3], 'room': 'X HQ', 'pos': None, 'status': 'provisional'},
    'Mission - Stop The Dig': {'id': 13632270, 'category': 'mission', 'detect': ['bit', 34620903, 2], 'room': 'M', 'pos': None, 'status': 'provisional'},
    'Mission - Repel The Army': {'id': 13632271, 'category': 'mission', 'detect': ['bit', 34620903, 5], 'room': 'O', 'pos': None, 'status': 'provisional'},
    'Mission - Destroy Model W': {'id': 13632272, 'category': 'mission', 'detect': ['bit', 34620904, 1], 'room': 'D-4D-5', 'pos': None, 'status': 'provisional'},
    'Quest - Find The Flower': {'id': 13632340, 'category': 'quest', 'detect': ['bit', 34620908, 2], 'room': 'A-1', 'pos': None, 'status': 'provisional'},
    'Quest - Trim The Weeds': {'id': 13632341, 'category': 'quest', 'detect': ['bit', 34620909, 0], 'room': 'C-2', 'pos': None, 'status': 'provisional'},
    'Quest - Find The Boy': {'id': 13632342, 'category': 'quest', 'detect': ['bit', 34620909, 7], 'room': 'G-1G-2', 'pos': None, 'status': 'provisional'},
    'Quest - Quiz Partner': {'id': 13632343, 'category': 'quest', 'detect': ['bit', 34620910, 3], 'room': 'C-1C-3', 'pos': None, 'status': 'provisional'},
    'Quest - Another Quiz': {'id': 13632344, 'category': 'quest', 'detect': ['bit', 34620911, 1], 'room': 'C-1C-3', 'pos': None, 'status': 'provisional'},
    'Quest - Purify The Lakes': {'id': 13632345, 'category': 'quest', 'detect': ['bit', 34620911, 5], 'room': 'B-4', 'pos': None, 'status': 'provisional'},
    'Quest - Find Mushroom': {'id': 13632346, 'category': 'quest', 'detect': ['bit', 34620912, 1], 'room': 'A-2', 'pos': None, 'status': 'provisional'},
    'Quest - Sending A Letter': {'id': 13632347, 'category': 'quest', 'detect': ['bit', 34620912, 5], 'room': 'C-2', 'pos': None, 'status': 'provisional'},
    'Quest - Sending Another Letter': {'id': 13632348, 'category': 'quest', 'detect': ['bit', 34620913, 1], 'room': 'C-2', 'pos': None, 'status': 'provisional'},
    'Quest - Yet Another Letter': {'id': 13632349, 'category': 'quest', 'detect': ['bit', 34620913, 5], 'room': 'C-2', 'pos': None, 'status': 'provisional'},
    'Quest - Not Another Letter': {'id': 13632350, 'category': 'quest', 'detect': ['bit', 34620914, 1], 'room': 'C-2', 'pos': None, 'status': 'provisional'},
    'Quest - Guess What A Letter': {'id': 13632351, 'category': 'quest', 'detect': ['bit', 34620914, 6], 'room': 'C-2', 'pos': None, 'status': 'provisional'},
    'Quest - One More Letter': {'id': 13632352, 'category': 'quest', 'detect': ['bit', 34620915, 4], 'room': 'C-2', 'pos': None, 'status': 'provisional'},
    'Quest - Deliver A Reply': {'id': 13632353, 'category': 'quest', 'detect': ['bit', 34620916, 2], 'room': 'X-1 HQ', 'pos': None, 'status': 'provisional'},
    'Quest - Find The Purse': {'id': 13632354, 'category': 'quest', 'detect': ['bit', 34620917, 0], 'room': 'B-2', 'pos': None, 'status': 'provisional'},
    'Quest - Find The Pearl': {'id': 13632355, 'category': 'quest', 'detect': ['bit', 34620917, 7], 'room': 'F-2', 'pos': None, 'status': 'provisional'},
    'Quest - Find The Rock': {'id': 13632356, 'category': 'quest', 'detect': ['bit', 34620918, 5], 'room': 'K-1', 'pos': None, 'status': 'provisional'},
    'Quest - Smash The Rock': {'id': 13632357, 'category': 'quest', 'detect': ['bit', 34620919, 5], 'room': 'E-4', 'pos': None, 'status': 'provisional'},
    'Quest - Gather The Screws': {'id': 13632358, 'category': 'quest', 'detect': ['bit', 34620920, 1], 'room': 'K-3K-4K-5', 'pos': None, 'status': 'provisional'},
    'Quest - Clean The Room': {'id': 13632359, 'category': 'quest', 'detect': ['bit', 34620920, 6], 'room': 'C-1', 'pos': None, 'status': 'provisional'},
    'Quest - Deliver The Aid Kit': {'id': 13632360, 'category': 'quest', 'detect': ['bit', 34620921, 2], 'room': 'L-1L-2L-3', 'pos': None, 'status': 'provisional'},
...
ITEMS = {
    'Model ZX': {'id': 13664256, 'classification': 'progression', 'grant': ['model', 0]},
    'Biometal H': {'id': 13664257, 'classification': 'progression', 'grant': ['model', 1]},
    'Biometal F': {'id': 13664258, 'classification': 'progression', 'grant': ['model', 2]},
    'Biometal L': {'id': 13664259, 'classification': 'progression', 'grant': ['model', 3]},
    'Biometal P': {'id': 13664260, 'classification': 'progression', 'grant': ['model', 4]},
    'Biometal O': {'id': 13664261, 'classification': 'progression', 'grant': ['model', 5]},
    'Yellow Card Key': {'id': 13664512, 'classification': 'progression', 'grant': ['cardkey', 0]},
    'Green Card Key': {'id': 13664513, 'classification': 'progression', 'grant': ['cardkey', 1]},
    'Red Card Key': {'id': 13664514, 'classification': 'progression', 'grant': ['cardkey', 2]},
    'Blue Card Key': {'id': 13664515, 'classification': 'progression', 'grant': ['cardkey', 3]},
    'White Card Key': {'id': 13664516, 'classification': 'progression', 'grant': ['cardkey', 4]},
    'Purple Card Key': {'id': 13664517, 'classification': 'progression', 'grant': ['cardkey', 5]},
    'Life Up': {'id': 13664528, 'classification': 'useful', 'grant': ['lifeup']},
    'Sub Tank': {'id': 13664529, 'classification': 'useful', 'grant': ['subtank']},
    'Transerver Access': {'id': 13664544, 'classification': 'progression', 'grant': ['transerver']},
    'E-Crystals': {'id': 13664768, 'classification': 'filler', 'grant': ['ecrystals']},
    '1-Up': {'id': 13664769, 'classification': 'filler', 'grant': ['oneup']},
}
