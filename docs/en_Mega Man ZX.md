...
- `Missions`: complete `required_missions` of the 14 story missions (8 by default, `all` for every one), in any
  order. Every mission that is a check counts; the skipped intro and the final mission do not.
