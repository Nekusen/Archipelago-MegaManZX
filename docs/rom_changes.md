...
- New Game skips the whole tutorial. You start in the Transerver hub of the Guardian base with the model and the
  character of your options, on Normal difficulty, ready to play. Continue works as usual.
...
- The mission of the area you enter is accepted automatically (`mission_auto_accept`). On hub floors whose door leads
