...
@ Cave at 0x020C82A0 (rom.py ICON_RETRY_CAVE), hooks in ICON_RETRY_HOOKS.
...
lit_set_2:      .word AP_SET
        ...
        .org    0x020CB4A2
@ rom.py: thumb_bl(ICON_RETRY_HOOKS[0][0], ICON_RETRY_CAVE_RAM)
@ Inside pickup_mailbox.s: the refill think's own site belongs to the mailbox hook.
@ was: bl entity_anim_tick
        bl      icon_retry_cave

        .org    0x020A3A7E
@ rom.py: thumb_bl(ICON_RETRY_HOOKS[1][0], ICON_RETRY_CAVE_RAM)
@ Disk think FUN_020a3a6c.  was: bl entity_anim_tick
        bl      icon_retry_cave

        .org    0x020A3CAA
@ rom.py: thumb_bl(ICON_RETRY_HOOKS[2][0], ICON_RETRY_CAVE_RAM)
