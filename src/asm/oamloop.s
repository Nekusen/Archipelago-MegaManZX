...
@ Two one-instruction patches (rom.py OAMLOOP_BR_NEW, OAMLOOP2_BR_NEW); no cave.

        .thumb

        .org    0x02009C30
@ rom.py: OAMLOOP_BR_NEW
@ was: beq 0x02009C36   (OAMLOOP_BR_ORIG)
        bls     0x02009C36              @ first drawer: exit of the sprite loop

        .org    0x02009D7C
@ rom.py: OAMLOOP2_BR_NEW
@ was: beq 0x02009D82   (OAMLOOP2_BR_ORIG)
