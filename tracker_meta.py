...
ROOMS = {
    ...
    'k02': {'area_map': 10, 'area_xf': [0, 548, 0.25], 'room_map': 65, 'room_xf': [0, 34, 1.0], 'sub': None},
    'k03': {'area_map': 10, 'area_xf': [262, 548, 0.25], 'room_map': 66, 'room_xf': [0, 34, 1.0], 'sub': 54},
    'k04': {'area_map': 10, 'area_xf': [780, 548, 0.25], 'room_map': 67, 'room_xf': [0, 34, 0.444444], 'sub': 55},
    'k05': {'area_map': 10, 'area_xf': [0, 1116, 0.25], 'room_map': 68, 'room_xf': [0, 34, 0.655599], 'sub': 56},
    'l01': {'area_map': 11, 'area_xf': [0, 124, 0.25], 'room_map': 69, 'room_xf': [0, 34, 0.25], 'sub': 57},
    'l02': {'area_map': 11, 'area_xf': [0, 452, 0.25], 'room_map': 70, 'room_xf': [0, 34, 0.444444], 'sub': 58},
    'l03': {'area_map': 11, 'area_xf': [0, 1020, 0.25], 'room_map': 71, 'room_xf': [0, 34, 0.444444], 'sub': 59},
    'l04': {'area_map': 11, 'area_xf': [0, 1588, 0.25], 'room_map': 72, 'room_xf': [0, 34, 0.5], 'sub': 60},
    'm01': {'area_map': 12, 'area_xf': [0, 124, 0.25], 'room_map': 73, 'room_xf': [0, 34, 0.25], 'sub': 61},
    'm02': {'area_map': 12, 'area_xf': [0, 404, 0.25], 'room_map': 74, 'room_xf': [0, 34, 0.5], 'sub': 62},
    'm03': {'area_map': 12, 'area_xf': [0, 828, 0.25], 'room_map': 75, 'room_xf': [0, 34, 0.5], 'sub': 63},
    'n01': {'area_map': 13, 'area_xf': [0, 34, 0.5], 'room_map': 76, 'room_xf': [0, 34, 0.5], 'sub': 64},
    'o01': {'area_map': 14, 'area_xf': [0, 124, 0.25], 'room_map': 77, 'room_xf': [0, 34, 0.25], 'sub': 65},
    'o02': {'area_map': 14, 'area_xf': [0, 596, 0.25], 'room_map': 78, 'room_xf': [0, 34, 0.25], 'sub': 66},
    'x01': {'area_map': 15, 'area_xf': [0, 124, 0.4], 'room_map': 79, 'room_xf': [0, 34, 0.5], 'sub': 67},
    'x02': {'area_map': 15, 'area_xf': [0, 932, 0.4], 'room_map': 80, 'room_xf': [0, 34, 1.0], 'sub': 68},
    'x03': {'area_map': 15, 'area_xf': [825, 932, 0.4], 'room_map': 81, 'room_xf': [0, 34, 1.0], 'sub': 69},
    'z01': {'area_map': None, 'area_xf': None, 'room_map': 82, 'room_xf': [0, 34, 0.338374], 'sub': 70},
    'z02': {'area_map': None, 'area_xf': None, 'room_map': 83, 'room_xf': [0, 34, 0.349653], 'sub': 71},
}

# Overall map: index and (x, y) point of the marker of every area
OVERALL_MAP = None
OVERALL_POINTS = {}
# Overall map: (x, y) point of the box of every room (position icon outside the hub)
OVERALL_ROOM_POINTS = {}
